        ...
        <div class="hidden md:flex items-center justify-between h-16 gap-6">
          ...
          <div class="flex items-center gap-2 flex-shrink-0">
            ...
            >
              ...
              >
                <!-- Header avec "Voir tout" en haut à droite -->
                <div
                ...
                >
                  <h3 class="text-base font-semibold text-gray-900">
                    Notifications
                    <span
                      class="ml-2 px-2 py-0.5 text-xs font-semibold bg-primary-500 text-white rounded-full"
                    >
                      {{ notificationsCount }}
                    </span>
                  </h3>
                ...
                >
                  <a
                    *ngFor="let notif of notifications.slice(0, 5)"
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-start justify-between gap-2">
                        <div class="flex-1">
                          ...
                          <p
                            class="text-sm text-gray-600 text-left line-clamp-2"
                          >
                            {{ notif.message }}
                          </p>
